...
class Ui_AppSettings(object):
    def setupUi(self, AppSettings):
        ...
        self.gridLayout_3.addWidget(self.chk_auto_save, 0, 0, 1, 1)
        ...
        self.le_archive_path = QtWidgets.QLineEdit(self.groupBox)
        self.le_archive_path.setObjectName("le_archive_path")
        self.gridLayout.addWidget(self.le_archive_path, 1, 1, 1, 1)
        self.le_library_path = QtWidgets.QLineEdit(self.groupBox)
        self.le_library_path.setObjectName("le_library_path")
        self.gridLayout.addWidget(self.le_library_path, 2, 1, 1, 1)
        self.cmd_archive_path = QtWidgets.QPushButton(self.groupBox)
        self.cmd_archive_path.setObjectName("cmd_archive_path")
        self.gridLayout.addWidget(self.cmd_archive_path, 1, 2, 1, 1)
        self.cmd_library_path = QtWidgets.QPushButton(self.groupBox)
        self.cmd_library_path.setObjectName("cmd_library_path")
        self.gridLayout.addWidget(self.cmd_library_path, 2, 2, 1, 1)
    ...
    def retranslateUi(self, AppSettings):
        ...
        self.chk_auto_save.setText(_translate("AppSettings", "Automatic save every change"))
        ...
        self.label_3.setText(_translate("AppSettings", "Online.xml archive"))
        self.label_5.setText(_translate("AppSettings", "Library path"))
        self.cmd_archive_path.setText(_translate("AppSettings", "Set folder"))
