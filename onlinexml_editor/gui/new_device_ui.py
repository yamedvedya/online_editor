...
class Ui_AddDevice(object):
    def setupUi(self, AddDevice):
        ...
        self.cmd_apply_template = QtWidgets.QPushButton(self.fr_template)
        self.cmd_apply_template.setObjectName("cmd_apply_template")
        self.horizontalLayout.addWidget(self.cmd_apply_template)
    ...
    def retranslateUi(self, AddDevice):
        ...
        self.cmd_apply_template.setText(_translate("AddDevice", "Apply template"))
